...
function ToggleGroup({
  ...
  return (
    <ToggleGroupPrimitive
      className={cn(
        "data-[spacing=0]:data-[variant=outline]: group/toggle-group flex w-fit flex-row items-center gap-[--spacing(var(--gap))] rounded-md data-[orientation=vertical]:flex-col data-[orientation=vertical]:items-stretch",
        className
      )}
