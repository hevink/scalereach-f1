...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
  ...
  return (
    <style
      // biome-ignore lint/security/noDangerouslySetInnerHtml: Safe - only injects CSS custom properties from controlled config
          ...
          .map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {renderItemContent(item, itemConfig, nestLabel)}
              </div>
            );
          })}
      </div>
